...
const projects = [
  ...
  {
    name: "Project Two: Flood Risk predictor",
    desc: "A machine-learning powered web application that predicts Flood/Disaster Risk Levels (Low / Medium / High) from uploaded heatmap images. Built with Flask + TensorFlow + OpenCV..",
    tags: ["Flask", "TensorFlow", "OpenCV", "Python"],
    link: "https://github.com/Alley18/ai-risk-prediction-project",
    linkLabel: "View on GitHub",
    status: "demo",
  },
  {
    name: "Project Three: Full Stack Car rental website",
    desc: "it is a car rental website built using react + tailwind for frontend and node + express + PostgreSQL for backend.",
    tags: ["React", "Node.js", "PostgreSQL"],
    link: "https://car-rent-beta-gules.vercel.app",
    linkLabel: "View Demo",
    status: "demo",
  },
  {
